...
;"object"==typeof exports&&"undefined"!=typeof module&&(module.exports=hljs);hljs.registerLanguage("x86asm",(()=>{"use strict";return s=>({
...
className:"meta",begin:/^\s*\.[\w_-]+/}]})})());hljs.registerLanguage("xml",(()=>{"use strict";function e(e){
...
className:"meta",begin:/^[\t ]*@/,end:/(?=#)|$/,contains:[b,p,o]}]}}})());hljs.registerLanguage("php",(()=>{"use strict";return e=>{const r={
className:"variable",
...
contains:[e.UNDERSCORE_TITLE_MODE]},l,s]}}})());hljs.registerLanguage("json",(()=>{"use strict";return e=>({name:"JSON",
